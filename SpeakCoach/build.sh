...
ARCHIVE_ARM="$BUILD_DIR/SpeakCoach-arm64.xcarchive"
ARCHIVE_X86="$BUILD_DIR/SpeakCoach-x86_64.xcarchive"
APP_NAME="SpeakCoach.app"
OUTPUT_DIR="$BUILD_DIR/universal"
OUTPUT_APP="$OUTPUT_DIR/$APP_NAME"
DMG_NAME="SpeakCoach.dmg"
...
xcodebuild archive \
  -project "$PROJECT_DIR/SpeakCoach.xcodeproj" \
  -scheme "$SCHEME" \
...
echo "   DMG:  $DMG_PATH"
echo ""
lipo -info "$OUTPUT_APP/Contents/MacOS/SpeakCoach"
