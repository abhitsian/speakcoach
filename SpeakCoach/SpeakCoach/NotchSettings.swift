...
class NotchSettings {
    ...
    var coachingEnabled: Bool {
        didSet { UserDefaults.standard.set(coachingEnabled, forKey: "coachingEnabled") }
    }
    var showSessionReport: Bool {
        didSet { UserDefaults.standard.set(showSessionReport, forKey: "showSessionReport") }
    }
    var customFillerWords: String {
        didSet { UserDefaults.standard.set(customFillerWords, forKey: "customFillerWords") }
    }
    ...
    init() {
        ...
        // Speech coaching
        self.coachingEnabled = UserDefaults.standard.object(forKey: "coachingEnabled") as? Bool ?? true
        self.showSessionReport = UserDefaults.standard.object(forKey: "showSessionReport") as? Bool ?? true
        self.customFillerWords = UserDefaults.standard.string(forKey: "customFillerWords") ?? ""
    }
}
