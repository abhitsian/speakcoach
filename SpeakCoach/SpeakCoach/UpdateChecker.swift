...
class UpdateChecker {
    ...
    private let repoOwner = "abhitsian"
    private let repoName = "speakcoach"
    ...
    private func showUpdateAvailable(latestVersion: String, releaseURL: String) {
        ...
        alert.informativeText = "SpeakCoach \(latestVersion) is available. You are currently running \(currentVersion)."
    ...
    private func showUpToDate() {
        ...
        alert.informativeText = "SpeakCoach \(currentVersion) is the latest version."
        alert.alertStyle = .informational
